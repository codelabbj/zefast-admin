...
import { LogOut, User, Moon, Sun, Bug, Menu, X, Lock } from "lucide-react"
...
export function DashboardHeader({ onToggleSidebar, sidebarOpen }: DashboardHeaderProps = {}) {
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 rounded-xl border-border/50 shadow-xl">
                ...
                <DropdownMenuItem onClick={() => setPasswordDialogOpen(true)} className="rounded-lg cursor-pointer">
      ...
      <UpdatePasswordDialog open={passwordDialogOpen} onOpenChange={setPasswordDialogOpen} />
    </>
  )
}
